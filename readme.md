...
7. If running oF 0.9.0 (64bit): replace the EDSDK.framework file in OF > addons > ofxEdsdk > src > EDSDK with the EDSDK.framework file from the EDSDK_64 directory in the .dmg files
